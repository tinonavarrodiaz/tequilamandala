<?php
    ...
    $sDestino = "tino@nh-digital.mx";
    $sAsunto = "Newsletter Mandala.com";
    $sMensaje = $_POST['txtMensa'];
    $sImagen = "./plantillas/logo.png";
    $sAdjunto = "./plantillas/logo.png";
    ...
    //CONFIGURACIÓN DEL EMISOR
        ...
        $mail->setFrom('no-reply@midominio.com', 'Jorny');
